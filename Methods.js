//charAt() - it returns the character at the specified index in the string
//The index of the first character is 0, the second is 1 etc.
...
//charCodeAt() - Returns an integer between 0 and 65535 representing the
//unicode at the given index.
...
//Concat() - merge 2 or more arrays. It does not change the existing
//arrays, but returns a new array
...
//among its entries, returning true or false.
...
//found in the array, or -1 if it's not present.
...
//match - retrieves the result of matching a string against a
//regular expression
...
//repeat - constructs and returns a new string which contains the
//specified number of copies of the string on which it was called
...
//by a replacement. The pattern can be a string and the replacement can
...
//search - searches a string for a specified value, and returns a
//position of the match. returns -1 if no match is found.
...
//array object selected from start to end where start and end represent
...
//split - divides a string into an ordered list of substrings, put
//these substrings into an array, and returns an array.
...
//substr - returns a portion of the string, starting at the specified
